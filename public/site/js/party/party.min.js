...
var totalAllowedAnimation = 3;
var animations;


var animate = function (elementId) {
    var element = document.getElementById(elementId);
    if (totalAnimation > totalAllowedAnimation) {
        clearInterval(animations);
    }
    party.confetti(element, { count: party.variation.range(30, 60) });
    party.sparkles(element, { count: party.variation.range(30, 60) });
    totalAnimation++;
}
function initiateAnimation(elementId) {
    animate(elementId);
    animations = setInterval(function () { animate(elementId); }, 1000);
}
