			...
			<div class="row justify-content-center">
				<div class="col-12 col-md-6 col-xl-4">
					<ul class="nav nav-tabs tabset justify-content-center mb-10" id="myTab" role="tablist">
						<li class="nav-item">
							<a class="nav-link tablink active" id="login-tab" data-toggle="tab" href="#login" role="tab" aria-controls="login" aria-selected="true">Department Login</a>
						</li>
						...
						<div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
							<form id="login_form" method="post">
								...
								<div class="form-group">
									...
									<input type="email" name="email_id" id="email_id" class="form-control " maxlength="50">
								</div>
								<div class="form-group">
...
<script>
	...
	$('#login_form').validate({
		...
		submitHandler: function(form) {
			...
			if (!(mailformat.test($('#email_id').val()))) 
			{
				$("#error_login").show();
				$('#error_login').html('Invalid Email Address.');
			} 
			else 
			{
