 ...
 public function getallotment_data_pf($countValue,$yearmonth,$seedValue,$district)
    ...
    $searchQueryCondition = "";
        if($searchQuery != ""){
            ...
            inner join mybillmyright.billdetail bd on  bs.billdetailid = bd.billdetailid
            inner join mybillmyright.mst_district md on  bs.distcode = md.distcode
            inner join mybillmyright.mst_user mu on  bs.userid = mu.userid where bs.p_status='2' and bs.distcode = '$distcode'  $searchQueryCondition";
            ...
            inner join mybillmyright.billdetail bd on  bs.billdetailid = bd.billdetailid
            inner join mybillmyright.mst_district md on  bs.distcode = md.distcode
            inner join mybillmyright.mst_user mu on  bs.userid = mu.userid where bs.p_status='3' and bs.distcode = '$distcode' $searchQueryCondition";
    ...
    public function totalRecordsWithOutFiltering($district,$role_type_id)
    {
        if($district == 'all'){
            ...
            inner join mybillmyright.mst_user mu on  bs.userid = mu.userid where  bs.p_status='0'";
                ...
                inner join mybillmyright.billdetail bd on  bs.billdetailid = bd.billdetailid
                inner join mybillmyright.mst_district md on  bs.distcode = md.distcode
                inner join mybillmyright.mst_user mu on  bs.userid = mu.userid where  bs.p_status='2' and bs.distcode = '$distcode'";
            }
             else if($role_type_id == '05'){
                $distcode = $_SESSION['user']->distcode ;
                $query = "select  count(*) as bstablecount
                ...
                inner join mybillmyright.billdetail bd on  bs.billdetailid = bd.billdetailid
                inner join mybillmyright.mst_district md on  bs.distcode = md.distcode
                inner join mybillmyright.mst_user mu on  bs.userid = mu.userid where  bs.p_status='3' and bs.distcode = '$distcode'";
            }
            $this->db->query($query);
            $row = $this->db->single();
        return $row;
        ...
        $distcode = $_SESSION['user']->distcode ;
         ...
         if( $rowperpage != -1){
            $query1 = "select  bs.bill_selection_id,md.distename,bd.mobilenumber,bd.billnumber,bd.billamount,bd.shopname,bd.billdate ,mu.name,bs.order_by_column,bd.filepath
                    ...
                    inner join mybillmyright.billdetail bd on  bs.billdetailid = bd.billdetailid
                    inner join mybillmyright.mst_district md on  bs.distcode = md.distcode
                    inner join mybillmyright.mst_user mu on  bs.userid = mu.userid where bs.distcode ='$distcode' and bs.p_status='3' $searchQueryCondition ORDER BY ".$columnName." ".$columnSortOrder." LIMIT $rowperpage offset $row";
         }
         else{
            $query1 = "select  bs.bill_selection_id,md.distename,bd.mobilenumber,bd.billnumber,bd.billamount,bd.shopname,bd.billdate ,mu.name,bs.order_by_column,bd.filepath
                    from mybillmyright.bill_selection_details bs 
                    inner join mybillmyright.billdetail bd on  bs.billdetailid = bd.billdetailid
                    inner join mybillmyright.mst_district md on  bs.distcode = md.distcode
                    inner join mybillmyright.mst_user mu on  bs.userid = mu.userid where bs.distcode ='$distcode' and bs.p_status='3' $searchQueryCondition ORDER BY ".$columnName." ".$columnSortOrder."";
         }
    ...
    public function getDcResults($countValue,$columnName,$columnSortOrder,$row,$rowperpage,$searchQueryCondition){
        ...
        if( $rowperpage != -1){
            ...
            $query1 = "select  bs.bill_selection_id,md.distename,bd.mobilenumber,bd.billnumber,bd.billamount,bd.shopname,bd.billdate ,mu.name, bs.order_by_column,bd.filepath
                    ...
                    inner join mybillmyright.billdetail bd on  bs.billdetailid = bd.billdetailid
                    inner join mybillmyright.mst_district md on  bs.distcode = md.distcode
                    inner join mybillmyright.mst_user mu on  bs.userid = mu.userid where bs.distcode ='$distcode' and bs.p_status='2' $searchQueryCondition ORDER BY ".$columnName." ".$columnSortOrder." LIMIT $rowperpage offset $row";
            ...
            $query1 = "select  bs.bill_selection_id,md.distename,bd.mobilenumber,bd.billnumber,bd.billamount,bd.shopname,bd.billdate ,mu.name, bs.order_by_column,bd.filepath
                    ...
                    inner join mybillmyright.billdetail bd on  bs.billdetailid = bd.billdetailid
                    inner join mybillmyright.mst_district md on  bs.distcode = md.distcode
                    inner join mybillmyright.mst_user mu on  bs.userid = mu.userid where bs.distcode ='$distcode' and bs.p_status='2' $searchQueryCondition ORDER BY ".$columnName." ".$columnSortOrder."";
