...
$yearmonth =date("Y").date('m');
 ...
 public function getallotment_data_pf($countValue,$yearmonth,$seedValue,$district)
            ...
            $columnSortOrder,$row,$rowperpage)
    {
        ...
        if($searchQuery != ""){
            $searchQueryCondition  = " AND ($searchQuery) ";
                ...
                $row = $this->verifiedDistrictBasedResults($searchQueryCondition,$columnName,$columnSortOrder,$row,$rowperpage );
                }
    ...
    public function verifiedAdcResults($searchQueryCondition, $columnName,
        ...
        public function verifiedDistrictBasedResults($searchQueryCondition, $columnName,
            $columnSortOrder,$row,$rowperpage){
        $row = (int)$row;
        $rowperpage = (int)$rowperpage;
        $columnName = "order_by_column";
...
// exit;
        ...
        for($i = 1;$i<=$cnt ;$i++){ //forloop start
            ...
            {  //if condition with Forloop
                ...
                if($data["r1_processcode"]== "F"){ // Forward start
           ...
           if($data["r1_processcode"]== "V"){ // Verify Start
        for($i = 1;$i<=$cnt ;$i++){ //forloop start
            if(isset($data['r'.$i."_processcode"]) && $data['r'.$i."_processcode"] !=""  && 
               isset($data['r'.$i."_remarks"]) && $data['r'.$i."_remarks"] !="" && 
                isset($data['r'.$i."_bsid"]) && $data['r'.$i."_bsid"] !="")
    ...
    for($i = 1;$i<=$cnt ;$i++){ //forloop start
            if(isset($data['r'.$i."_processcode"]) && $data['r'.$i."_processcode"] !=""  && 
            isset($data['r'.$i."_processcode"]) && $data['r'.$i."_processcode"] !="" && 
               isset($data['r'.$i."_remarks"]) && $data['r'.$i."_remarks"] !="" && 
                isset($data['r'.$i."_bsid"]) && $data['r'.$i."_bsid"] !="")
                 {  //if condition with Forloop
